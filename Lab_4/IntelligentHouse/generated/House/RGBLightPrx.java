...
public interface RGBLightPrx extends LightPrx
{
    ...
    {
        setColor(red, green, blue, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setColor(int red, int green, int blue, java.util.Map<String, String> context)
        throws InputException
    {
        try
        {
            _iceI_setColorAsync(red, green, blue, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<Void> setColorAsync(int red, int green, int blue)
    {
        return _iceI_setColorAsync(red, green, blue, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setColorAsync(int red, int green, int blue, java.util.Map<String, String> context)
    {
        return _iceI_setColorAsync(red, green, blue, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setColorAsync(int iceP_red, int iceP_green, int iceP_blue, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_red);
                     ostr.writeInt(iceP_green);
                     ostr.writeInt(iceP_blue);
                 }, null);
        return f;
    }
