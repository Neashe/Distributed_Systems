...
public class Work implements org.apache.thrift.TBase<Work, Work._Fields>, java.io.Serializable, Cloneable, Comparable<Work> {
   ...
   * @see OperationType
   */
  public @org.apache.thrift.annotation.Nullable OperationType op; // required
   ...
   * @see OperationType
   */
  public Work setOp(@org.apache.thrift.annotation.Nullable OperationType op) {
    this.op = op;
    return this;
  }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Work struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // OP
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.op = sr.rpc.thrift.OperationType.findByValue(iprot.readI32());
